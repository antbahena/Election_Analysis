...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_voter_count = county_votes[county_name]

        # 6b: Retrieve the county vote count.
        county_percentage = float(county_voter_count) / float(total_votes) * 100

        # 6c: Calculate the percentage of votes for the county.
        county_results = (
            f"{county_name}: {county_percentage:.1f}% ({county_voter_count:,})\n")
